...
from models.run_seal import run_seal
...
from utils.get_openai_em import get_openai_embeddings
...
def main():
    ...
    gene_sum, disease_sum = get_openai_embeddings(gene_sum, disease_sum)
    ...
    run_onheterograph(hetero_data, gene_sum, disease_sum, epoch, reducing_edges=False, embedding_mode="biobert")
